      ...
      <td colSpan={6}>
        <div style={{ padding: '80px 32px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16, textAlign: 'center' }}>
          ...
          <div style={{ color: 'var(--text-secondary)', maxWidth: 320, lineHeight: 1.6 }}>
            ...
            No orders have been placed yet. New customer orders will appear here once they are created.
          </div>
          <button onClick={()=>{}}>Create your first order</button>
      ...
      <td colSpan={6}>
        <div style={{ padding: '80px 32px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16, textAlign: 'center' }}>
          ...
          <button onClick={onRetry} style={{
            ...
            <img src="../../reloading.png" style={{height:"20px" , width:"20px"}}/>
